...
.factory('Items',['$firebaseArray', function($firebaseArray){
    var itemsRef = new Firebase('https://brilliant-torch-1425.firebaseio.com/items');
...
.controller("ListCtrl",function($scope,$ionicListDelegate,$cordovaDialogs, Items){
    ...
    $scope.purchaseItem = function(item){
        var itemRef = new Firebase('https://brilliant-torch-1425.firebaseio.com/items/'+item.$id);
